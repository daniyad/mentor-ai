...
function sortByDifficulty(order, arr) {
    if (order === "")
        return arr;
    var difficultyRule = { easy: 1, medium: 2, hard: 3 };
    if (order === "asc") {
        return arr.sort(function (a, b) {
            return difficultyRule[a.main.difficulty] -
                difficultyRule[b.main.difficulty];
        });
    }
    else {
        return arr.sort(function (a, b) {
            return difficultyRule[b.main.difficulty] -
...
function sortByAcceptance(order, arr) {
    ...
    if (order === "asc") {
        return arr.sort(function (a, b) {
            return b.main.acceptance_rate_count - a.main.acceptance_rate_count;
        });
    }
    else {
        return arr.sort(function (a, b) {
            return a.main.acceptance_rate_count - b.main.acceptance_rate_count;
        });
    }
}
...
function sortByTitle(order, arr) {
    if (order === "")
        return arr;
    if (order === "asc") {
        return arr.sort(function (a, b) { return a.main.id - b.main.id; });
    }
    else {
        return arr.sort(function (a, b) { return b.main.id - a.main.id; });
    }
}
